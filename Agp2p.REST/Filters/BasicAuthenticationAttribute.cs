...
using Lip2p.REST.Results;

namespace Lip2p.REST.Filters
{
    // 文档 http://www.asp.net/web-api/overview/security/authentication-filters
    // authentication 登录认证；authorization 用户鉴权
    public abstract class BasicAuthenticationAttribute : Attribute, IAuthenticationFilter
    {
        private const string Scheme = "Basic"; // 如果希望在浏览器提示填写帐号密码，则设置为 Basic
        ...
        private void Challenge(HttpAuthenticationChallengeContext context)
        {
            ...
            context.ChallengeWith(Scheme, parameter);
        }
