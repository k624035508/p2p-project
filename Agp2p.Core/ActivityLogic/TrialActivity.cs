...
namespace Agp2p.Core.ActivityLogic
{
    public class TrialActivity
    {
        ...
        public class TrialTicket
        {
            ...
            {
                Debug.Assert(atr.activity_type == (int) Agp2pEnums.ActivityTransactionActivityTypeEnum.Trial);
                this.atr = atr;
            }
        ...
        private static void NewUser(int userId, DateTime regTime)
        {
            if (Utils.IsDebugging() || newUserTrailStartTime <= regTime.Date)
            {
                ...
                var trs = new li_activity_transactions
                {
                    ...
                    activity_type = (byte)Agp2pEnums.ActivityTransactionActivityTypeEnum.Trial,
                };
