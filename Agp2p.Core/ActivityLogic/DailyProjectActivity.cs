...
namespace Agp2p.Core.ActivityLogic
{
    public class DailyProjectActivity
    {
        ...
        public class DailyProjectTicket
        {
            ...
            {
                Debug.Assert(atr.activity_type == (int) Agp2pEnums.ActivityTransactionActivityTypeEnum.DailyProject);
                this.atr = atr;
            }
            ...
            public void Use(Agp2pDataContext context, int projectId)
            {
                ...
                var repayTime = TransactionFacade.CalcRepayTime(useTime, termSpan,
                    termSpan == Agp2pEnums.ProjectRepaymentTermSpanEnum.Day ? 1 : proj.repayment_term_span_count,
            ...
            if (Utils.IsDebugging() || startTime <= investTime.Date && investTime.Date <= deadline)
            {
                ...
                var dailyTickets =
                    investedTr.dt_users.li_activity_transactions.Where(
                        t => t.activity_type == (int) Agp2pEnums.ActivityTransactionActivityTypeEnum.DailyProject)
                        .AsEnumerable()
                ...
                var dailyTr = new li_activity_transactions
                {
                    ...
                    activity_type = (byte) Agp2pEnums.ActivityTransactionActivityTypeEnum.DailyProject,
                };
