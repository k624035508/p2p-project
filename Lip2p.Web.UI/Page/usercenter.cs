    ...
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            if (action == "exit")
            {
                ...
                //清除Cookies
                Utils.WriteCookie(DTKeys.COOKIE_USER_NAME_REMEMBER, "Lip2p", -43200);
                Utils.WriteCookie(DTKeys.COOKIE_USER_PWD_REMEMBER, "Lip2p", -43200);
                Utils.WriteCookie("UserName", "Lip2p", -1);
                Utils.WriteCookie("Password", "Lip2p", -1);
                //自动登录,跳转URL
                HttpContext.Current.Response.Redirect(linkurl("login"));
            }

            //查询用户钱包
            var context = new Linq2SQL.Lip2pDataContext();
