...
namespace Lip2p.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        {
            return new Lip2pDataContext().li_bank_accounts.Where(b => b.owner == user_id).ToList();
        }
        ...
        {
            return
                new Lip2pDataContext().li_activity_transactions.Count(
                    t => t.user_id == userId && t.status == (int) Lip2pEnums.ActivityTransactionStatusEnum.Acting
