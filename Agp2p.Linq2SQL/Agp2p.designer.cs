...
namespace Agp2p.Linq2SQL
{
    ...
    partial void Insertli_questionnaire_result(li_questionnaire_result instance);
    partial void Updateli_questionnaire_result(li_questionnaire_result instance);
    partial void Deleteli_questionnaire_result(li_questionnaire_result instance);
    ...
    partial void Deletedt_article_attribute_value(dt_article_attribute_value instance);
		...
		public System.Data.Linq.Table<li_questionnaire_result> li_questionnaire_results
		{
			get
			{
				return this.GetTable<li_questionnaire_result>();
			}
		}
			...
			set
			{
							...
							|| (this._dt_article_category.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.dt_article.Remove(this);
					}
					this._dt_article_category.Entity = value;
					if ((value != null))
					{
						value.dt_article.Add(this);
	...
	public partial class dt_article_category : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<dt_article> _dt_article;
    ...
    partial void Onseo_descriptionChanged();
		...
		{
			this._dt_article = new EntitySet<dt_article>(new Action<dt_article>(this.attach_dt_article), new Action<dt_article>(this.detach_dt_article));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="dt_article_category_dt_article", Storage="_dt_article", ThisKey="id", OtherKey="category_id")]
		public EntitySet<dt_article> dt_article
		{
			get
			{
				return this._dt_article;
			}
			set
			{
				this._dt_article.Assign(value);
			}
		}
		...
		private void attach_dt_article(dt_article entity)
		{
			this.SendPropertyChanging();
			entity.dt_article_category = this;
		}
		
		private void detach_dt_article(dt_article entity)
		{
			this.SendPropertyChanging();
	...
	public partial class li_claims : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<li_projects> _li_projects_profiting;
    ...
    partial void OnkeepInterestChanged();
		...
		public li_claims()
		{
			...
			this._li_projects = default(EntityRef<li_projects>);
			this._li_projects_profiting = default(EntityRef<li_projects>);
			this._dt_users = default(EntityRef<dt_users>);
		...
		public int profitingProjectId
		{
			...
			set
			{
				...
				{
					if (this._li_projects_profiting.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="li_projects_li_claims1", Storage="_li_projects_profiting", ThisKey="profitingProjectId", OtherKey="id", IsForeignKey=true)]
		public li_projects li_projects_profiting
		{
			get
			{
				return this._li_projects_profiting.Entity;
			}
			set
			{
				li_projects previousValue = this._li_projects_profiting.Entity;
				if (((previousValue != value) 
							|| (this._li_projects_profiting.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._li_projects_profiting.Entity = null;
						previousValue.li_claims_profiting.Remove(this);
					}
					this._li_projects_profiting.Entity = value;
					if ((value != null))
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="dt_users_li_claims1", Storage="_dt_users_agent", ThisKey="agent", OtherKey="id", IsForeignKey=true)]
	...
	public partial class li_projects : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<li_claims> _li_claims_profiting;
    ...
    partial void OnautoRepayChanged();
		...
		public li_projects()
		{
			...
			this._li_claims_profiting = new EntitySet<li_claims>(new Action<li_claims>(this.attach_li_claims_profiting), new Action<li_claims>(this.detach_li_claims_profiting));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="li_projects_li_claims1", Storage="_li_claims_profiting", ThisKey="id", OtherKey="profitingProjectId")]
		public EntitySet<li_claims> li_claims_profiting
		{
			get
			{
				return this._li_claims_profiting;
			}
			set
			{
				this._li_claims_profiting.Assign(value);
			}
		}
		...
		private void attach_li_claims_profiting(li_claims entity)
		{
			this.SendPropertyChanging();
			entity.li_projects_profiting = this;
		}
		
		private void detach_li_claims_profiting(li_claims entity)
		{
			this.SendPropertyChanging();
    ...
    partial void OnprotocolCodeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="dt_users_li_claims1", Storage="_li_claims_byAgent", ThisKey="id", OtherKey="agent")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="dt_users_li_questionnaire_result", Storage="_li_questionnaire_results", ThisKey="id", OtherKey="userId")]
		public EntitySet<li_questionnaire_result> li_questionnaire_results
		{
			get
			{
				return this._li_questionnaire_results;
			}
			set
			{
				this._li_questionnaire_results.Assign(value);
			}
		}
		...
		private void attach_li_questionnaire_results(li_questionnaire_result entity)
		{
			this.SendPropertyChanging();
			entity.dt_users = this;
		}
    ...
    partial void OntypeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_opening_bank", DbType="NVarChar(50)")]
	...
	public partial class dt_advert : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<dt_advert_banner> _dt_advert_banner;
    ...
    partial void OnstatusChanged();
		...
		public dt_advert()
		{
			this._dt_advert_banner = new EntitySet<dt_advert_banner>(new Action<dt_advert_banner>(this.attach_dt_advert_banner), new Action<dt_advert_banner>(this.detach_dt_advert_banner));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="dt_advert_dt_advert_banner", Storage="_dt_advert_banner", ThisKey="id", OtherKey="aid")]
		public EntitySet<dt_advert_banner> dt_advert_banner
		{
			get
			{
				return this._dt_advert_banner;
			}
			set
			{
				this._dt_advert_banner.Assign(value);
			}
		}
		...
		private void attach_dt_advert_banner(dt_advert_banner entity)
		{
			this.SendPropertyChanging();
			entity.dt_advert = this;
		}
		
		private void detach_dt_advert_banner(dt_advert_banner entity)
		{
			this.SendPropertyChanging();
			entity.dt_advert = null;
		}
	}
	...
	public partial class dt_advert_banner : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<dt_advert> _dt_advert;
    ...
    partial void Onadd_timeChanged();
		...
		{
			this._dt_advert = default(EntityRef<dt_advert>);
			OnCreated();
		}
		...
		public int aid
		{
			...
			set
			{
				if ((this._aid != value))
				{
					if (this._dt_advert.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="dt_advert_dt_advert_banner", Storage="_dt_advert", ThisKey="aid", OtherKey="id", IsForeignKey=true)]
		public dt_advert dt_advert
		{
			get
			{
				return this._dt_advert.Entity;
			}
			set
			{
				dt_advert previousValue = this._dt_advert.Entity;
				if (((previousValue != value) 
							|| (this._dt_advert.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._dt_advert.Entity = null;
						previousValue.dt_advert_banner.Remove(this);
					}
					this._dt_advert.Entity = value;
					if ((value != null))
					{
						value.dt_advert_banner.Add(this);
						this._aid = value.id;
					}
					else
					{
					...
					this.SendPropertyChanged("dt_advert");
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.li_questionnaire_results")]
	public partial class li_questionnaire_result : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnanswerChanged();
		...
		public li_questionnaire_result()
		{
			this._dt_users = default(EntityRef<dt_users>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_questionnaireId", DbType="Int NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="dt_users_li_questionnaire_result", Storage="_dt_users", ThisKey="userId", OtherKey="id", IsForeignKey=true)]
		public dt_users dt_users
		{
			get
			{
			...
			set
			{
							...
							|| (this._dt_users.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._dt_users.Entity = null;
						previousValue.li_questionnaire_results.Remove(this);
					}
					this._dt_users.Entity = value;
					if ((value != null))
					{
						value.li_questionnaire_results.Add(this);
						this._userId = value.id;
					}
					else
					{
    ...
    partial void Onpoint_limitChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_point_limit", DbType="Int")]
		public System.Nullable<int> point_limit
		{
			get
			{
				return this._point_limit;
			}
			set
			{
				if ((this._point_limit != value))
				{
					this.Onpoint_limitChanging(value);
					this.SendPropertyChanging();
