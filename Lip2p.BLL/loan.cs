...
namespace Lip2p.BLL
{
    public class loan
    {
        protected Lip2pDataContext Context;

        public loan(Lip2pDataContext context)
        {
            Context = context;
        }
        ...
        public void LoadAlbum(li_risks model, Lip2pEnums.AlbumTypeEnum type, int splittedIndex, HttpRequest request)
        {
