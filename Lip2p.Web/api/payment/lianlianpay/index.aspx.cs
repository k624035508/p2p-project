    ...
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (action.Equals("recharge") || action.Equals("bankgateway") || action.Equals("wap"))//测试充值
            {
                ...
                var charge_order = context.Charge(user_id, decimal.Parse(amount), Lip2pEnums.PayApiTypeEnum.Lianlianpay);
                ...
                else
                {
                    ...
                    int bankCode = (int)(Lip2pEnums.LianlianpayBankCodeEnum)Enum.Parse(typeof(Lip2pEnums.LianlianpayBankCodeEnum), bankName);
