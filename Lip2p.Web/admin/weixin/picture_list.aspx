<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="picture_list.aspx.cs" Inherits="Lip2p.Web.admin.weixin.picture_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center">
      <%#new Lip2p.BLL.weixin_request_content().GetCount(Convert.ToInt32(Eval("id")))%> 条
    </td>
