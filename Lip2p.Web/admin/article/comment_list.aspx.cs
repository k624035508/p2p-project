...
namespace Lip2p.Web.admin.article
{
    public partial class comment_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind("channel_id=" + this.channel_id + CombSqlTxt(txtKeywords.Text, this.property), "add_time desc");
            }
        }
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("comment_list.aspx", "channel_id={0}&keywords={1}&property={2}&page={3}",
                this.channel_id.ToString(), txtKeywords.Text, this.property, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("comment_list.aspx", "channel_id={0}&keywords={1}&property={2}",
               this.channel_id.ToString(), txtKeywords.Text, ddlProperty.SelectedValue));
        }
        ...
        protected void btnAudit_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("审核通过成功！", Utils.CombUrlTxt("comment_list.aspx", "channel_id={0}&keywords={1}&property={2}",
                this.channel_id.ToString(), txtKeywords.Text, this.property), "Success");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！",
                Utils.CombUrlTxt("comment_list.aspx", "channel_id={0}&keywords={1}&property={2}", this.channel_id.ToString(), txtKeywords.Text, this.property), "Success");
        }
    }
}