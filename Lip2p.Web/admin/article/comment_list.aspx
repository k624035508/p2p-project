<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_list.aspx.cs" Inherits="Lip2p.Web.admin.article.comment_list" %>
  ...
  <tr>
    <td class="comment">
      <div class="title">
        ...
        <%#new Lip2p.BLL.article().GetTitle(Convert.ToInt32(Eval("article_id")))%>
      </div>
      <div class="ask">
