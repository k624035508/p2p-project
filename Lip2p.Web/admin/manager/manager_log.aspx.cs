    ...
    public partial class manager_log : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind("id>0" + CombSqlTxt(txtKeywords.Text), "add_time desc,id desc");
            }
        }
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("manager_log.aspx", "keywords={0}&page={1}", txtKeywords.Text, "__id__");
