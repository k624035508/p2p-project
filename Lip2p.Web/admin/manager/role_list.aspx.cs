    ...
    public partial class role_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind("role_type>=" + model.role_type + CombSqlTxt(txtKeywords.Text));
            }
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("role_list.aspx", "keywords={0}", txtKeywords.Text), "Success");
        }
