<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_edit.aspx.cs" Inherits="Lip2p.Web.admin.manager.manager_edit" ValidateRequest="false" %>
...
<div class="tab-content">
 ...
 <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlDepartment" runat="server" datatype="*" errormsg="请选择所属部门" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlLeader" runat="server"></asp:DropDownList>
      </div>
    </dd>
  </dl>
</div>
