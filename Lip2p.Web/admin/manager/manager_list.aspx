<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_list.aspx.cs" Inherits="Lip2p.Web.admin.manager.manager_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Lip2p.BLL.department().GetDepartmentName(Convert.ToInt32(Eval("department_id")))%></td>
