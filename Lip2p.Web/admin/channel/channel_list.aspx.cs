    ...
    public partial class channel_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                TreeBind(); //绑定类别
                RptBind("id>0" + CombSqlTxt(category_id, txtKeywords.Text), "sort_id asc,id desc");
            }
        }
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("channel_list.aspx", "category_id={0}&keywords={1}&page={2}", this.category_id.ToString(), txtKeywords.Text, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("channel_list.aspx", "category_id={0}&keywords={1}", ddlCategoryId.SelectedValue, txtKeywords.Text));
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功！", Utils.CombUrlTxt("channel_list.aspx", "category_id={0}&keywords={1}", this.category_id.ToString(), txtKeywords.Text), "Success", "parent.loadMenuTree");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！",
                Utils.CombUrlTxt("channel_list.aspx", "category_id={0}&keywords={1}", this.category_id.ToString(), txtKeywords.Text), "Success", "parent.loadMenuTree");
        }
    }
}