<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="channel_list.aspx.cs" Inherits="Lip2p.Web.admin.channel.channel_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#Eval("name")%></td>
    <td><%#Eval("title")%></td>
    <td><%#new Lip2p.BLL.channel_category().GetTitle(Convert.ToInt32(Eval("category_id")))%></td>
