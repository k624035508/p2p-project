    ...
    public partial class category_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind("id>0" + CombSqlTxt(txtKeywords.Text), "sort_id asc,id desc");
            }
        }
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("category_list.aspx", "keywords={0}&page={1}", txtKeywords.Text, "__id__");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功！", Utils.CombUrlTxt("category_list.aspx", "keywords={0}", txtKeywords.Text), "Success", "parent.loadMenuTree");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("category_list.aspx", "keywords={0}", txtKeywords.Text), "Success", "parent.loadMenuTree");
        }
    }
}