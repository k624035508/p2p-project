...
namespace Lip2p.Web.admin.channel
{
    public partial class attribute_field_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind("id>0" + CombSqlTxt(this.control_type, txtKeywords.Text), "is_sys desc,sort_id asc,id desc");
            }
        }
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("attribute_field_list.aspx", "control_type={0}&keywords={1}&page={2}", this.control_type, txtKeywords.Text, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("attribute_field_list.aspx", "control_type={0}&keywords={1}", ddlControlType.SelectedValue, txtKeywords.Text));
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功！", Utils.CombUrlTxt("attribute_field_list.aspx", "control_type={0}&keywords={1}", this.control_type, txtKeywords.Text), "Success");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("attribute_field_list.aspx", "control_type={0}&keywords={1}", this.control_type, txtKeywords.Text), "Success");
        }
