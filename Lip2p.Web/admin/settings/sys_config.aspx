<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="Lip2p.Web.admin.settings.sys_config" ValidateRequest="false" %>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-multi-radio">
        ...
        <asp:ListItem Value="0" Selected="True">关闭上传</asp:ListItem>
        <asp:ListItem Value="1">自动上传</asp:ListItem>
        </asp:RadioButtonList>
      </div>
    </dd>
  </dl>
...
<div class="tab-content" style="display:none">
    ...
    <dl>
        ...
        <dd>
            <div class="rule-single-checkbox">
                <asp:CheckBox ID="sendRepayAnnounceAfterRepay" runat="server" />
            </div>
            <span class="Validform_checktip">*</span>
        </dd>
    </dl>
