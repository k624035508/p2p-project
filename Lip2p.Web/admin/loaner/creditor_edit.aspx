<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="creditor_edit.aspx.cs" Inherits="Lip2p.Web.admin.loaner.creditor_edit" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <dl>
    <dt>昵称</dt>
    <dd><asp:Literal ID="lblNickName" runat="server"/></dd>
  </dl>
  <dl>
    <dt>电话</dt>
      <dd><asp:Literal ID="lblTel" runat="server"/></dd>
  </dl>
  <dl>
    <dt>邮箱</dt>
      <dd><asp:Literal ID="lblEmail" runat="server"/></dd>
  </dl>
  <dl>
    <dt>真实姓名</dt>
    <dd><asp:TextBox ID="txtRealName" runat="server" CssClass="input normal" datatype="/^\S{2,}$/"></asp:TextBox><span class="Validform_checktip">*</span></dd>
  </dl>
  <dl>
    <dt>身份证号码</dt>
