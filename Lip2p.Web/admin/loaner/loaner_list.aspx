<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loaner_list.aspx.cs" Inherits="Lip2p.Web.admin.loaner.loaner_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li style="display: none"><a class="add" href="loaner_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
