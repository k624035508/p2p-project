...
{
    public partial class financing_edit : Web.UI.ManagePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == DTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改信息成功！", "financing_list.aspx?channel_id=" + this.channel_id, "Success");
            }
            else //添加
            {
                ...
                JscriptMsg("添加信息成功！", "financing_list.aspx?channel_id=" + this.channel_id, "Success");
            }
        }
    }
}