...
{
    public partial class projectContent_edit : Web.UI.ManagePage
    {
            ...
            foreach (Model.article_attribute_field modelt in ls)
            {
                ...
                switch (modelt.control_type)
                {
                    case "single-text": //单行文本
                        ...
                        {
                            txtControl.CssClass = "input date";
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == DTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改信息成功！", "projectContent_list.aspx?channel_id=" + this.channel_id, "Success");
            }
            else //添加
            {
                ...
                JscriptMsg("添加信息成功！", "projectContent_list.aspx?channel_id=" + this.channel_id, "Success");
            }
        }
    }
}