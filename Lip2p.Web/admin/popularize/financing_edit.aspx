<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="financing_edit.aspx.cs" Inherits="Lip2p.Web.admin.popularize.financing_edit" ValidateRequest="false" %>
...
<!--导航栏-->
<div class="location">
  <a href="financing_list.aspx?channel_id=<%=this.channel_id %>" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="financing_list.aspx?channel_id=<%=this.channel_id %>"><span>内容管理</span></a>
  <i class="arrow"></i>
  <span>编辑信息</span>
</div>
