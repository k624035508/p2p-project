...
namespace Lip2p.Web.admin.popularize
{
    public partial class financing_list : Web.UI.ManagePage
    {
        ...
        private void RptBind(int _channel_id, int _category_id,string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("financing_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("financing_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        protected void lbtnViewTxt_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("financing_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功啦！", Utils.CombUrlTxt("financing_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        protected void btnAudit_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量审核成功！", Utils.CombUrlTxt("financing_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property), "Success");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("financing_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property), "Success");
        }
    }
}