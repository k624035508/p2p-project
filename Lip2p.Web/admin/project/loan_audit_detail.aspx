...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="loan_apply.aspx?channel_id=<%=this.ChannelId %>" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i><a href="loan_apply.aspx?channel_id=<%=this.ChannelId %>">
        ...
        <div class="tab-content">
            ...
            <% if (LoanType == (int)Lip2pEnums.LoanTypeEnum.Company)
                { %>
            <dl>
                <dt>企业信息</dt>
                <dd>
            ...
            <dl>
                ...
                <dd>
                    <table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
                        <% if (LoanType == (int)Lip2pEnums.LoanTypeEnum.Creditor)
                            { %>
                        <tr>
                            <th width="20%">债权人
                            </th>
