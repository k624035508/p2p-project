<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="project_edit_reset.aspx.cs"
    Inherits="Lip2p.Web.admin.project.project_edit_reset" ValidateRequest="false" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function SelectMortgageSetting(risk_id, channel_id, project_id) {
            var dialog = $.dialog({
                title: '选择标的信息',
                content: 'url:dialog/dialog_mortgage_setting.aspx?risk_id=' + risk_id + '&channel_id=' + channel_id + '&project_id=' + project_id + '&pageName=reset',
                min: false,
                max: false,
                lock: true,
                width: 550,
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="project_list_publish.aspx?channel_id=<%=this.channel_id %>" class="back"><i>
        </i><span>返回列表页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
        <i class="arrow"></i><a href="project_list_publish.aspx?channel_id=<%=this.channel_id %>">
            <span>项目发布</span></a> <i class="arrow"></i><span>项目调整</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
        ...
        <div id="floatHead" class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    ...
                    <li id="tab_item_mortgages"><a id="a_item_mortgages" href="javascript:;"
                        onclick="tabs(this);">标的信息</a></li>
                    <li id="tab_item_risks"><a href="javascript:;" onclick="tabs(this);">
                        风控信息</a></li>
        ...
        <dl>
            <dd style="margin-left: 50px; text-align: center;">
                <div class="order-flow" style="width: 560px">
                    ...
                    <%if (project_status >= (int)Lip2p.Common.Lip2pEnums.ProjectStatusEnum.FaBiao)
                      { %>
                    <div class="order-flow-arrive">
    ...
    <div class="page-footer">
        <div class="btn-list">            
            <asp:Button ID="btnLiBiao" runat="server" Text="保存" CssClass="btn" OnClick="btnReset" />            
