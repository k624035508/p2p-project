<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bank_transaction_charging_list.aspx.cs" Inherits="Lip2p.Web.admin.audit.bank_transaction_charging_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><asp:Label ID="lb_pay_type" runat="server" Text='<%# Eval("pay_api") == null ? "" : Utils.GetLip2pEnumDes((Lip2pEnums.PayApiTypeEnum)Convert.ToByte(Eval("pay_api")))%>'></asp:Label></td>
