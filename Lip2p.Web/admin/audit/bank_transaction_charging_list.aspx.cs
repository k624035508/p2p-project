...
namespace Lip2p.Web.admin.audit
{
    public partial class bank_transaction_charging_list : UI.ManagePage
    {
        ...
        private void RptBind()
        {
            ...
            var query =
                context.li_bank_transactions.Where(b => b.type == (int) (Lip2pEnums.BankTransactionTypeEnum.Charge));
            //用户分组查询
        ...
        protected void btnConfirmCancel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Lip2p.API.Payment.Ecpss.Service ecpssService = new API.Payment.Ecpss.Service();
                ...
                for (int i = 0; i < rptList.Items.Count; i++)
                {
                    ...
                    {
                        //调用汇潮接口查询订单是否已到账
                        if (pay_type != Utils.GetLip2pEnumDes(Lip2pEnums.PayApiTypeEnum.Ecpss) || ecpssService.CheckRechargeOrder(no_order))
                        {
