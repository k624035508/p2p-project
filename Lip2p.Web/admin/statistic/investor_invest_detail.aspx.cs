                ...
                var investorInvestDetails = g.Select(tr =>
                {
                    ...
                    var profitRate = proj.invest_complete_time == null
                        ? proj.profit_rate = // cache in project rate for 小计
                            TransactionFacade.CalcFinalProfitRate(now, proj.profit_rate_year, (Lip2pEnums.ProjectRepaymentTermSpanEnum) proj.repayment_term_span, proj.repayment_term_span_count)
                        : proj.profit_rate;
                    ...
                    return new InvestorInvestDetail
                    {
                        ...
                        ProjectCompleteTime =
                            proj.invest_complete_time == null
                                ? "(未满标)"
                                : TransactionFacade.CalcRepayTime(proj.invest_complete_time.Value, (Lip2pEnums.ProjectRepaymentTermSpanEnum) proj.repayment_term_span,
                                    proj.repayment_term_span_count, proj.repayment_term_span_count).ToString(),
                        ProjectName = proj.title,
                        Term = proj.repayment_term_span_count + Utils.GetLip2pEnumDes((Lip2pEnums.ProjectRepaymentTermSpanEnum) proj.repayment_term_span),
