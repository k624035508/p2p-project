<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wallet_history_list.aspx.cs" Inherits="Lip2p.Web.admin.statistic.wallet_history_list" %>
<%@ Import namespace="Lip2p.Common" %>
<%@ Import Namespace="Lip2p.Linq2SQL" %>
<%@ Import Namespace="Lip2p.BLL" %>
<%@ Import Namespace="Lip2p.Core" %>
...
<ItemTemplate>
  <tr>
    <td style="padding-left: 1em;"><%# Container.ItemIndex + pageSize * (page - 1) + 1 %></td>
      ...
      <% } %>
    <td style="text-align:center"><%# Utils.GetLip2pEnumDes((Lip2pEnums.WalletHistoryTypeEnum) Convert.ToByte(Eval("action_type")))%></td>    
