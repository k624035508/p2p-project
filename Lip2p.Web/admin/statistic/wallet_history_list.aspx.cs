...
namespace Lip2p.Web.admin.statistic
{
    public partial class wallet_history_list : UI.ManagePage
    {
        ...
        readonly int[] _ignoringHistoryTypesSpecificUser =
            {
                (int) Lip2pEnums.WalletHistoryTypeEnum.Withdrawing, (int) Lip2pEnums.WalletHistoryTypeEnum.WithdrawCancel,
                (int) Lip2pEnums.WalletHistoryTypeEnum.Charging, (int) Lip2pEnums.WalletHistoryTypeEnum.ChargeCancel,
            };
        readonly int[] _ignoringHistoryTypes =
            {
                (int) Lip2pEnums.WalletHistoryTypeEnum.Withdrawing, (int) Lip2pEnums.WalletHistoryTypeEnum.WithdrawCancel,
                (int) Lip2pEnums.WalletHistoryTypeEnum.Charging, (int) Lip2pEnums.WalletHistoryTypeEnum.ChargeCancel,
                (int) Lip2pEnums.WalletHistoryTypeEnum.InvestSuccess,(int)Lip2pEnums.WalletHistoryTypeEnum.Gaining,
                (int) Lip2pEnums.WalletHistoryTypeEnum.Losting
            };
        ...
        protected void TreeBind()
        {
            ...
            var listItems = Utils.GetEnumValues<Lip2pEnums.WalletHistoryTypeEnum>()
        ...
        readonly Dictionary<Lip2pEnums.WalletHistoryTypeEnum, string> RemarkHintMap = new Dictionary<Lip2pEnums.WalletHistoryTypeEnum, string>
        {
            {Lip2pEnums.WalletHistoryTypeEnum.Invest, "投资 {0}"},
            {Lip2pEnums.WalletHistoryTypeEnum.InvestorRefund, "投资撤回 {0}"},
            {Lip2pEnums.WalletHistoryTypeEnum.InvestSuccess, "项目满标 {0} {1}"},
            {Lip2pEnums.WalletHistoryTypeEnum.RepaidInterest, "{0} 放款 {1}"},
            {Lip2pEnums.WalletHistoryTypeEnum.RepaidPrincipal, "{0} 放款 {1}"},
            {Lip2pEnums.WalletHistoryTypeEnum.RepaidPrincipalAndInterest, "{0} 放款 {1}"}
        };
        ...
        protected string QueryTransactionRemark(li_wallet_histories his, Func<li_wallet_histories, string> projectNameMapper)
        {
            ...
            {
                if (his.li_project_transactions.type != (int) Lip2pEnums.ProjectTransactionTypeEnum.Invest)
                {
                    // 查出 还款期数/总期数
                    var term = context.li_wallet_histories.Count(
                        h => h.user_id == his.user_id && h.create_time <= his.create_time &&
                             (h.action_type == (int) Lip2pEnums.WalletHistoryTypeEnum.RepaidInterest ||
                              h.action_type == (int) Lip2pEnums.WalletHistoryTypeEnum.RepaidPrincipal ||
                              h.action_type == (int) Lip2pEnums.WalletHistoryTypeEnum.RepaidPrincipalAndInterest) &&
                    ...
                    return string.Format(RemarkHintMap[(Lip2pEnums.WalletHistoryTypeEnum)his.action_type], projectNameMapper(his), repaytaskInfo);
                }
                return his.li_project_transactions.li_projects.invest_complete_time.HasValue
                    ? string.Format(RemarkHintMap[(Lip2pEnums.WalletHistoryTypeEnum)his.action_type], projectNameMapper(his),
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            var query = QueryWalletHistories().OrderByDescending(h => h.id)
                ...
                .Take(pageSize).AsEnumerable().Select(h => new
                {
                    ...
                    actionType = Utils.GetLip2pEnumDes((Lip2pEnums.WalletHistoryTypeEnum)h.action_type),
