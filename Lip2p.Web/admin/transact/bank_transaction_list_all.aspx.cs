    ...
    public partial class bank_transaction_list_all : UI.ManagePage
    {
        ...
        protected void btnConfirm_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                var bankTransactionType = (Lip2pEnums.BankTransactionTypeEnum) Convert.ToByte(bt.type);
                var remark = (bankTransactionType == Lip2pEnums.BankTransactionTypeEnum.Withdraw
                    ? ("确认银行账户 " + bt.li_bank_accounts.account)
                    : ("确认用户 " + bt.dt_users.user_name)) + " " + Utils.GetLip2pEnumDes(bankTransactionType) + "成功, 涉及金额: " + bt.value;
        ...
        protected void btnCancel_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                var remark = (bankTransactionType == Lip2pEnums.BankTransactionTypeEnum.Withdraw
                    ...
                    : ("取消用户 " + bt.dt_users.user_name)) + " " + Utils.GetLip2pEnumDes(bankTransactionType) + "成功, 涉及金额: " + bt.value;
