<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bank_transaction_list_all.aspx.cs" Inherits="Lip2p.Web.admin.transact.bank_transaction_list_all" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="bank_transaction_charge.aspx?user_id=<%=user_id %>"><i></i><span>充值</span></a></li>
      </ul>
    </div>
  </div>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="left" width="5%">交易类型</th>
    <th align="left" width="5%">支付平台</th>
    <th align="left" width="5%">交易状态</th>
    <th align="left" width="15%">手续费</th>
...
<ItemTemplate>
  <tr>
    ...
    <td><%# Utils.GetLip2pEnumDes((Lip2pEnums.BankTransactionTypeEnum) Convert.ToByte(Eval("type")))%></td>
    <td><%# Eval("pay_api") != null ? Utils.GetLip2pEnumDes((Lip2pEnums.PayApiTypeEnum)Convert.ToByte(Eval("pay_api"))) : ""%></td>
    ...
    <td><asp:Button ID="btnConfirm" runat="server" Text="确认" UseSubmitBehavior="False" CommandArgument='<%# Eval("id") %>' OnClientClick="return ExeNoCheckPostBack(this.name, '确认银行交易？');"
        OnClick="btnConfirm_OnClick" Visible='<%# Convert.ToByte(Eval("status")) == (byte) Lip2pEnums.BankTransactionStatusEnum.Acting%>'/>
        ...
        OnClick="btnCancel_OnClick" Visible='<%# Convert.ToByte(Eval("status")) == (byte) Lip2pEnums.BankTransactionStatusEnum.Acting%>'/></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
