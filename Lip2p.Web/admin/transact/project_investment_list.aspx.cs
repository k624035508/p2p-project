        ...
        private void RptBind()
        {
            ...
            var query =
                context.li_project_transactions.Where(
                    t => t.project == projectId && t.type == (int) Lip2pEnums.ProjectTransactionTypeEnum.Invest);
        ...
        protected string queryProfitStatus(li_project_transactions tr)
        {
            var profits = context.li_project_transactions.Where(
                a =>
                    ...
                    (a.type == (int) Lip2pEnums.ProjectTransactionTypeEnum.RepaidInterest ||
                     a.type == (int) Lip2pEnums.ProjectTransactionTypeEnum.RepaidPrincipalAndInterest))
