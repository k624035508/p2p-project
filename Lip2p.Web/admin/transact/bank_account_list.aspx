<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bank_account_list.aspx.cs" Inherits="Lip2p.Web.admin.transact.bank_account_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="bank_account_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&user_id=<%=user_id%>"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="bank_account_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%# Eval("bank") %></a></td>
    <td><%# Eval("opening_bank") %></td>
    <td><%# Eval("account") %></td>
    <td><a href="bank_transaction_withdraw.aspx?account_id=<%# Eval("id") %>">提现</a></td>
