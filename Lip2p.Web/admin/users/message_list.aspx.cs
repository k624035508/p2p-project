    ...
    public partial class message_list : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("message_list.aspx", "type_id={0}&keywords={1}&page={2}",
                this.type_id.ToString(), txtKeywords.Text, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("message_list.aspx", "type_id={0}&keywords={1}", ddlType.SelectedValue, txtKeywords.Text));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！",
                Utils.CombUrlTxt("message_list.aspx", "type_id={0}&keywords={1}", this.type_id.ToString(), txtKeywords.Text), "Success");
        }
