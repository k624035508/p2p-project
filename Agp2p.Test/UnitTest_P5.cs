...
namespace Agp2p.Test
{
    ...
    public class UnitTest_P5
    {
        ...
        */
        ...
        private readonly DateTime TestStartAt = new DateTime(2016, 03, 21, 15, 20, 00);/* 开始测试前请设置好实际日期 */
        ...
        public void Day07()
        {
            ...
            Common.AssertWalletDelta(UserB, 6.95m - 50000 * staticClaimWithdrawCostPercent, 0, 0, 0, 0, 0, 50000, 6.95m, TestStartAt);
