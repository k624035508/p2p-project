        ...
        */
        ...
        public void Day03()
        {
            ...
            /* 公司账号接手 30000
               公司账号接手 20000 */
            // 两次买入的时间可交换再进行测试
            Common.BuyClaim("P3-2", CompanyAccount, 20000 + 2.78m);
            Common.BuyClaim("P3-2", CompanyAccount, 30000 + 4.17m);
        ...
        public void Day06()
        {
            ...
            Common.AssertWalletDelta(CompanyAccount, 27.77m, 0, 0, 0, 0, 0, 50000, 34.72m, realDate);
        }
