...
namespace Agp2p.Test
{
    ...
    public class UnitTest_P2_2
    {
        ...
        */
        ...
        readonly DateTime realDate = new DateTime(2016, 04, 13, 8, 30, 00); /* 开始测试前请设置好实际日期 */
        ...
        public void Day03()
        {
            ...
            // A 提现 35000
            Common.StaticProjectWithdraw("P2", UserA, 35000, 0);
        ...
        public void Day07()
        {
            ...
            Common.AssertWalletDelta(UserA, 0m /*- 35000 * staticClaimWithdrawCostPercent*/, 0, 0, 0, 0, 0, 35000, 0, realDate);
            Common.AssertWalletDelta(UserB, 17.36m, 0, 0, 0, 0, 0, 25000, 17.36m, realDate);
            Common.AssertWalletDelta(CompanyAccount, 24.31m, 0, 0, 0, 0, 0, 35000, 24.31m, realDate);
        }
