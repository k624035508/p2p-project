<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prepositPay.aspx.cs" Inherits="Agp2p.Web.api.payment.lianlianpay.prepositPay" %>
...
<body>
    <form id="pay_form" name="pay_form" method="post" action="index.aspx" target="_blank">        
        <table border="0" cellspacing="0" cellpadding="0" class="table_ui">
           <tr>
                <td colspan="2">
                    <span class="ft_gray">第三方支付测试</span>
                </td>
            </tr>
            <tr>
                <td width="100">
            ...
            <tr>
                <td colspan="2">
                	<input type="hidden" id="user_id" name="user_id" value="306" />                  
                    <input type="hidden" id="action" name="action" value="recharge" /> 
                    
                    <input type="hidden" id="Hidden1" name="no_order" value="20150409214850041211" /> 
                    <input type="hidden" id="Hidden2" name="dt_order" value="20150409214850" /> 

                    <input id="btnSubmit" name="btnSubmit" type="submit" class="btn_submit" value="认证支付" onclick="return paySubmit();"/>
                    <input id="Submit2" name="btnSubmit" type="submit" class="btn_submit" value="网银支付" onclick="queryOrder('bankgateway');"/>
                    <input id="Submit1" name="btnSubmit" type="submit" class="btn_submit" value="查询支付" onclick="queryOrder('query');"/>
                </td>
            </tr>
        </table>
    </form>
