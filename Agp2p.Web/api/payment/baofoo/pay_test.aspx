<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pay_test.aspx.cs" Inherits="Agp2p.Web.api.payment.baofoo.pay_test" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <input type="button" onclick="dosubmit()" value=" 提 交 " />&nbsp;<br />
        </div>
    </form>
</body>
</html>
