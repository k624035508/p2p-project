<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menu_edit.aspx.cs" Inherits="Agp2p.Web.admin.weixin.menu_edit" ValidateRequest="false" %>
...
<div id="floatHead" class="content-tab-wrap">
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a class="selected" href="javascript:;" onclick="tabs(this);">自定义菜单</a></li>
