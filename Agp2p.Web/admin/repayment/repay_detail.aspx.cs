...
{
    public partial class repay_detail : Web.UI.ManagePage
    {
        ...
        {
            ChkAdminLevel("repay_detail", DTEnums.ActionEnum.View.ToString()); //检查权限      
        ...
        private void ShowByStatus()
        {
            switch (RepayStatus)
            {
                case (int)Agp2pEnums.RepaymentStatusEnum.Unpaid:
        ...
        protected void btnRepay_OnClick(object sender, EventArgs e)
        {
