        ...
        <asp:Repeater ID="rptList_summary" runat="server" Visible="False">
            ...
            <ItemTemplate>
                <tr <%# ((RepaymentTaskAmountDetail)Container.DataItem).Project.Index == null ? "class='sum'" : ""%>>
                    ...
                    <td style="text-align: center"><%# Convert.ToDecimal(Eval("RepayPrincipal")).ToString("c")%></td>
                    <td style="text-align: center"><%# Convert.ToDecimal(Eval("RepayInterest")).ToString("c")%></td>
