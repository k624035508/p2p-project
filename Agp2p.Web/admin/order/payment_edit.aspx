<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment_edit.aspx.cs" Inherits="Lip2p.Web.admin.order.payment_edit" ValidateRequest="false" %>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#form1").initValidform();
        //初始化上传
        $(".upload-img").InitSWFUpload({ filesize: "<%=siteConfig.imgsize %>", sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf" });
    });
</script>
</head>
