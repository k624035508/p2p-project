<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_list.aspx.cs" Inherits="Agp2p.Web.admin.article.comment_list" %>
  ...
  <tr>
    <td class="comment">
      <div class="title">
        ...
        <%#new Agp2p.BLL.article().GetTitle(Convert.ToInt32(Eval("article_id")))%>
      </div>
      <div class="ask">
