<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_edit.aspx.cs" Inherits="Agp2p.Web.admin.article.article_edit" ValidateRequest="false" %>
...
<body class="mainbody">
<form id="form1" runat="server"><dl id="div_project_profit_rate" runat="server"></dl>
<!--导航栏-->
<div class="location">
