<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_list.aspx.cs" Inherits="Agp2p.Web.admin.manager.manager_list" %>
    ...
    <div class="r-list">
        <div class="menu-list" style="display: inline-block; float: left; margin-right: 8px; margin-left: 8px;">
            <div class="rule-single-select">
                <asp:DropDownList ID="ddlDepartments" AutoPostBack="True" runat="server" OnSelectedIndexChanged="ddlDepartments_SelectedIndexChanged"></asp:DropDownList>
            </div>
        </div>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Agp2p.BLL.department().GetDepartmentName(Convert.ToInt32(Eval("department_id")))%></td>
