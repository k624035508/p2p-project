    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>电话</dt>
                <dd>
                    <asp:TextBox ID="txtTel" runat="server" CssClass="input normal" Enabled="False"></asp:TextBox><span class="Validform_checktip"> 要修改灰色字段请在会员管理页面修改</span></dd>
            </dl>
            <dl>
                <dt>身份证号码</dt>
                <dd>
                    <asp:TextBox ID="txtIdCardNumber" runat="server" CssClass="input normal" Enabled="False" /></dd>
            </dl>
            <dl>
                <dt>电子邮件</dt>
                <dd>
                    <asp:TextBox ID="txtEmail" runat="server" CssClass="input normal" Enabled="False" /></dd>
            </dl>
            <dl>
                <dt>年龄</dt>
                <dd>
            ...
            <dl>
                <dt>学历</dt>
                <dd>
                    <asp:TextBox ID="txtEducationalBackground" runat="server" CssClass="input normal" datatype="/^\S+$/" /><span class="Validform_checktip">* </span></dd>
            </dl>
            <dl>
                <dt>婚姻状态</dt>
                <dd>
            ...
            <dl>
                <dt>收入</dt>
                <dd>
                    <asp:TextBox ID="txtIncome" runat="server" CssClass="input normal" datatype="/^.+$/" /><span class="Validform_checktip">* </span></dd>
            </dl>
            <dl>
                <dt>涉诉情况</dt>
                <dd>
            ...
            <dl>
                <dt>借款额度</dt>
                <dd>
                    <asp:TextBox ID="txtQuota" runat="server" CssClass="input normal" datatype="/^\d+$/" /><span class="Validform_checktip">(0表示无限制)</span></dd>
            </dl>
            <dl>
                <dt>身份证照片</dt>
                <dd>
