...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i>
            <a href="guarantor_list.aspx"><span>机构列表</span></a>
            <i class="arrow"></i>
            <span>编辑机构</span>
        </div>
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">编辑机构</a></li>
        ...
        <div class="tab-content">
            <dl>
                <dt>机构名称</dt>
                <dd>
                    <asp:TextBox ID="txtGuarantorName" runat="server" CssClass="input normal" datatype="/^\S+$/"></asp:TextBox><span class="Validform_checktip">* </span></dd>
            </dl>
            <dl>
                <dt>注册号</dt>
                <dd>
                    <asp:TextBox ID="txtRegistNumber" runat="server" CssClass="input normal" datatype="/^.+$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>类型</dt>
                <dd>
            ...
            <dl>
                <dt>法定代表人</dt>
                <dd>
                    <asp:TextBox ID="txtLegalPerson" runat="server" CssClass="input normal" datatype="/^.+$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>注册资本</dt>
                <dd>
                    <asp:TextBox ID="txtRegisteredCapital" runat="server" CssClass="input normal" datatype="/^.+$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>成立日期</dt>
                <dd>
            ...
            <dl>
                <dt>公司地址</dt>
                <dd>
                    <asp:TextBox ID="txtAddr" runat="server" CssClass="input normal" datatype="/^.+$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>经营范围</dt>
                <dd>
                    <asp:TextBox ID="txtBusinessScope" runat="server" CssClass="input normal" datatype="/^.+$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>描述</dt>
                <dd>
                    <asp:TextBox ID="txtDescription" runat="server" CssClass="input normal" datatype="/^.+$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>额度管理-合作业务品种</dt>
                <dd>
                    <asp:TextBox ID="txtCMBusinessTypes" runat="server" CssClass="input normal" datatype="/^.+$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>合作时间</dt>
                <dd>
                    <asp:TextBox ID="txtCMCooperationTime" runat="server" CssClass="input normal" datatype="/^.+$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>合作总额度</dt>
                <dd>
                    <asp:TextBox ID="txtCMCooperationTotalDegree" runat="server" CssClass="input normal" datatype="/^.+$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>已使用额度</dt>
                <dd>
                    <asp:TextBox ID="txtCMCooperationUsedDegree" runat="server" CssClass="input normal" datatype="/^.+$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>额度余额</dt>
                <dd>
                    <asp:TextBox ID="txtCMCooperationRemainDegree" runat="server" CssClass="input normal" datatype="/^.+$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>机构资料</dt>
                <dd>
