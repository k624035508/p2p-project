<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="company_edit.aspx.cs" Inherits="Agp2p.Web.admin.loaner.company_edit" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            <dl>
                <dt>已关联借款人</dt>
                <dd>
                    <asp:TextBox ID="txtLoaners" runat="server" CssClass="input normal" datatype="/^\S+$/" /><span class="Validform_checktip">* 请输入人员账号/姓名，用英文逗号隔开</span></dd>
            </dl>
            <dl>
                <dt>企业名称</dt>
                <dd>
    ...
    <dl>
        ...
        <dd><asp:TextBox ID="txtNetAssets" runat="server" CssClass="input normal" datatype="/^.*$/"></asp:TextBox></dd>
            ...
            <dl>
                <dt>地址</dt>
                <dd>
                    <asp:TextBox ID="txtAddress" runat="server" CssClass="input normal" datatype="/^.*$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>备注</dt>
                <dd>
                    <asp:TextBox ID="txtCompanyRemark" runat="server" CssClass="input normal" datatype="/^.*$/"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>企业照片</dt>
                <dd>
