<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_attach.aspx.cs" Inherits="Agp2p.Web.admin.dialog.dialog_attach" %>
...
<script type="text/javascript">
    ...
    //页面加载完成执行
    $(function () {
        $(".upload-attach").InitSWFUpload({ filesize: "<%=siteConfig.attachsize %>", sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf", filetypes: "*.<%=siteConfig.fileextension.Replace(",",";*.") %>" });
