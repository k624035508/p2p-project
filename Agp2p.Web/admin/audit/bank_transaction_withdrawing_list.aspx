<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bank_transaction_withdrawing_list.aspx.cs" Inherits="Agp2p.Web.admin.audit.bank_transaction_withdrawing_list" %>
...
<FooterTemplate>
  <%#rptList.Items.Count >0 ? "<tr><td colspan=\"2\"></td><td style=\"color: red;\">总计</td><td style=\"color: red;\">"+Convert.ToDecimal(value).ToString("c")+"</td><td style=\"color: red;\">"+Convert.ToDecimal(value1).ToString("c")+"</td><td colspan=\"9\">&nbsp;</td></tr>" : ""%>
...
<asp:Repeater ID="rptList_summary" runat="server" Visible="False">
    ...
    <ItemTemplate>
        <tr <%# ((GroupByUserGroupSummery)Container.DataItem).Index == null ? "class='sum'" : ""%>>
            ...
            <td style="text-align: right"><%# Convert.ToDecimal(Eval("WithdrawAmount")).ToString("c")%></td>
