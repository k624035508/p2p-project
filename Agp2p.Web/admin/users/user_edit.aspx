    ...
    <form id="form1" runat="server" autocomplete="off">
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">借款人信息</a></li>
                        <li><a href="javascript:;" onclick="tabs(this);">基本资料</a></li>
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>学历</dt>
                <dd>
                    <asp:TextBox ID="txtEducationalBackground" runat="server" CssClass="input normal" datatype="/^\S+$/"></asp:TextBox><span class="Validform_checktip">* </span></dd>
            </dl>
            <dl>
                <dt>婚姻状态</dt>
                <dd>
