...
<head runat="server">
    ...
    <style type="text/css">
        ...
        table.ltable td, table.ltable th {
            text-align: right;
        }
    </style>
            ...
            <ItemTemplate>
                <tr <%# string.Equals(Eval("GroupName"), "总计") ? "class='sum'" : "" %>>
                    <td class="align-center">
                        <asp:CheckBox ID="chkId" CssClass="checkall" runat="server" Visible='<%#!string.Equals("总计", Eval("GroupName"))%>' /><asp:HiddenField ID="hidId" Value='<%#Eval("id")%>' runat="server" />
                    </td>
                    <td class="align-center">
