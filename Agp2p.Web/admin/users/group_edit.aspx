<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_edit.aspx.cs" Inherits="Agp2p.Web.admin.users.group_edit" %>
...
<body class="mainbody">
    ...
    <div class="tab-content" style="height: 600px">
        ...
        <dl>
            <dt>升级所需积分：</dt>
            <dd>
                <asp:TextBox ID="txtUpgradeExp" runat="server" CssClass="input small" datatype="/^-?\d+$/"
        ...
        <dl>
            <dt>初始积分：</dt>
            <dd>
                <asp:TextBox ID="txtPoint" runat="server" CssClass="input small" datatype="/^-?\d+$/" sucmsg=" "></asp:TextBox><span
