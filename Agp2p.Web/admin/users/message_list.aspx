<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="message_list.aspx.cs" Inherits="Agp2p.Web.admin.users.message_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#Eval("title")%></td>
    <td><%#Eval("is_read").GetType() != Type.GetType("System.DBNull") && Convert.ToInt32(Eval("is_read")) == 1 ? "已阅读" : "未阅读"%></td>
