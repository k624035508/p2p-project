    ...
    public partial class oauth_app_list : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
           ...
           // txtKeywords.Text = this.keywords;
            ...
            string pageUrl = Utils.CombUrlTxt("oauth_app_list.aspx", "keywords={0}&page={1}", txtKeywords.Text, "__id__");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("oauth_app_list.aspx", "keywords={0}", txtKeywords.Text), "Success");
        }
    }
}