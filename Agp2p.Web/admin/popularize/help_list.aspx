<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="help_list.aspx.cs" Inherits="Agp2p.Web.admin.popularize.help_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="help_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>&category_id=<%=this.category_id %>"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><a href="help_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
...
<ItemTemplate>
    <li>
      <div class="details<%#Eval("img_url").ToString() != "" ? "" : " nopic"%>">
        ...
        <h1><span><a href="help_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></span></h1>
        <div class="remark">
        ...
        <div class="foot">
          ...
          <a href="help_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>" title="编辑" class="edit">编辑</a>
        </div>
      </div>
    </li>
</ItemTemplate>
