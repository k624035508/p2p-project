<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bank_transaction_list_all.aspx.cs" Inherits="Agp2p.Web.admin.transact.bank_transaction_list_all" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%# Eval("pay_api") != null ? Utils.GetAgp2pEnumDes((Agp2pEnums.PayApiTypeEnum)Convert.ToByte(Eval("pay_api"))) : ""%></td>
