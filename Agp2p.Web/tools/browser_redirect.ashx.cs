        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (siteConfig.mobiledomain != "")
            {
                if (HttpContext.Current.Request.UrlReferrer != null)
                {
                    ...
                    str.Append("location.href='http://" + siteConfig.mobiledomain + "/" + urlReferrer.Substring(urlReferrer.LastIndexOf("/") + 1) + "';");
                }
                else
            ...
            else
            {
                if (HttpContext.Current.Request.UrlReferrer != null)
                {
                    ...
                    if (!urlReferrer.Contains("download"))
                    {
                        ...
                        str.Append("location.href='" + siteConfig.webpath + "download/android-v2.0.apk';");
