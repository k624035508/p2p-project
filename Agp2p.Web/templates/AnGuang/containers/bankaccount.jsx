        ...
        return (
            <div className="bank-account-wrap">
                ...
                <div className="warm-tips-style">
                    ...
                    <p>3、银行卡开户行信息须填写完整，如无法确定开户行信息，建议您致电开户行进行咨询；</p>
                    <p>4、变更银行卡需上传身份证照片、手持原绑定银行卡照片、手持新绑定银行卡照片，客服审核之后，将在7个</p>
                    <p className="recTipsOther">工作日内为您更换；</p>
                    <p>5、如您银行卡变更申请未通过审核，提现银行卡则默认为原绑定银行卡。</p>
                </div>
            </div>
        );
    }
