...
namespace Lip2p.DAL
{
    ...
    public partial class manager
    {
        ...
        public int Add(Model.manager model)
        {
            ...
            strSql.Append("role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,parent_id,department_id,is_default)");
            ...
            parameters[10].Value = model.parent_id;
            parameters[11].Value = model.department_id;
            parameters[12].Value = model.is_default;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,parent_id,department_id,is_default from " + databaseprefix + "manager ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,parent_id,department_id,is_default ");
