...
namespace Lip2p.API.Weixin.Handler
{
    /// <summary>
    /// 自定义MessageHandler
    ...
    public partial class CustomMessageHandler : Senparc.Weixin.MP.MessageHandlers.MessageHandler<CustomMessageContext>
    {
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            try
            {
                ...
                //new BLL.weixin_response_content().Add(accountId, requestMessage.FromUserName, requestMessage.MsgType.ToString(), requestMessage.Content, "text", "", string.Empty);
            }
            catch (Exception ex)
            {
