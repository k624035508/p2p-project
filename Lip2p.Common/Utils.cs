...
namespace Lip2p.Common
{
    public static class Utils
    {
        ...
        /// <returns></returns>
        public static string GetLip2pEnumDes(Enum en)
        {
        ...
        public static string GetLip2pEnumDes<T>(string intStr)
        {
            return GetLip2pEnumDes(Enum.Parse(typeof (T), intStr) as Enum);
        }
